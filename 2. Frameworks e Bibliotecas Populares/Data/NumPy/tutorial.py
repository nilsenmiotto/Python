...
print(
    "Índices dos valores únicos = ", indices
)  # Output: [ 0  2  3  4  5  6  7 12 13 14]

print("Matriz original = ", minha_matriz)
print(
    "Matriz reshapeada (1x9) = ", minha_matriz.reshape(1, 9)
)  # Output: [[1 2 3 4 5 6 7 8 9]]
print(
    "Matriz reshapeada (3x3) = ", minha_matriz.reshape(3, 3)
)  # Output: [[1 2 3] [4 5 6] [7 8 9]]
